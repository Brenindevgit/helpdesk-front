...
export class TecnicoCreateComponent implements OnInit {
  ...
  create(): void {
    // ATENÇÃO: Aqui passamos os valores do formulário para o objeto antes de enviar
    ...
    console.log("CLIQUEI NO BOTÃO CRIAR");
    console.log("Dados que estou enviando:", this.tecnico);
